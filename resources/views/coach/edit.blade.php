        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card-box col-md-9">
                    ...
                    <form action="{{ url('/coach/'. $items->id) }}" method="post" data-parsley-validate novalidate>
                        {{csrf_field()}}
                        @method("put")
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <input name="id_number"  value="{{$items->id_number}}" maxlength="9" placeholder="ادخل رقم الهوية" disabled data-parsley-equalto="#pass1" type="text"
