        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card-box col-md-9">
                    ...
                    <form action="{{asset('/courses')}}" method="post" data-parsley-validate novalidate>
                        {{csrf_field()}}
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <input id="datepicker" value="{{old('start_course')}}" name="start_course" type="text" placeholder="ادخل تاريخ بداية الدورة"
                                   class="form-control">
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <input id="pass1" value="{{old('time')}}" name="time" type="number" placeholder="ادخل عدد ايام الدورة"
                                   class="form-control">
                        </div>
